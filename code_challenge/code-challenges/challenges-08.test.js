...
const containsAnd = (arr) => {
  return arr.filter((ele) => ele.match("and"));
};
...
const filterStringsWithVowels = (arr) => {
  return arr.filter((ele) => ele.match(/a|e|i|o|u/));
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  return arr.filter((ele) => !forbiddenValues.includes(ele));
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  return arr.filter((ele) => ele.baseStat > minBaseStat);
};
...
const getStatName = (arr, minBaseStat) => {
  return arr
    .filter((ele) => ele.baseStat > minBaseStat)
